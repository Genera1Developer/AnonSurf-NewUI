...
```txt
I had to switch editors multiple times because of VSCode's shitty pip install errors, saying I have the package when I don't.
VSCodium Didn't help much either but I coded in there for a while (I didn't change much but I'm working on V2 in it now)
So I had to use thonny to manualy install the packages from the Plugins Manager.
```
